...
})({"bJgGN":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
async function createUser(email1, password1) {
    try {
        const newUser = await _auth.createUserWithEmailAndPassword(auth, email1, password1);
        console.log(newUser);
    } catch (error) {
        console.log(error);
        if (error.code === "auth/weak-password") alert("Password must be at least 6 characters long");
        if (error.code === "auth/email-already-in-use") alert("That email is already in use");
    }
}
...
},{"@firebase/util":"ePiK6","@firebase/app":"3AcPV","tslib":"lRdW5","@firebase/logger":"fZmft","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bJgGN","8PXZT"], "8PXZT", "parcelRequire8ba2")

//# sourceMappingURL=registerPage.5a6d67e9.js.map

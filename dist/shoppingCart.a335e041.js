...
})({"9K28f":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "692a6ecca335e041";
...
},{}],"abTAw":[function(require,module,exports) {
...
function validate(db, auth) {
    onAuthStateChanged(auth, (user)=>{
        if (user) {
            const uid = user.uid;
            _firestore.getDoc(_firestore.doc(db, "users", uid)).then((docSnap)=>{
                const result = docSnap.data();
                console.log(result.admin);
                if (result.admin) window.location.href = "./addItems.html";
...
},{}]},["9K28f","abTAw"], "abTAw", "parcelRequire8ba2")

//# sourceMappingURL=shoppingCart.a335e041.js.map
